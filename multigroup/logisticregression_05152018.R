...
for (i in 1:4) {
  for (j in 1:12) {
    for (r in 1:100) {
      the.filename.io<-paste0("M:/xstudy2/Simulation/aim02/July2017/sim/knownclass/rerun/",all.sets[[i]][j],"/",all.sets[[i]][j],"_r",r,"_io_v.dat")
      the.filename.ud<-paste0("M:/xstudy2/Simulation/aim02/July2017/sim/knownclass/rerun/",all.sets[[i]][j],"/",all.sets[[i]][j],"_r",r,"_ud_v.dat")
