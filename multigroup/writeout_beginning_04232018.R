...
for (i in 1:4) {
  for (j in 1:12) {
    for (r in 1:100) {
      ...
      the.datafile.ud.3step<-paste0(all.sets[[i]][j],"_r",r,"_io_v.dat")
      ...
      the.ud.name<-paste("M:/xstudy2/Simulation/aim02/July2017/sim/knownclass/rerun/",all.sets[[i]][j],"/",all.sets[[i]][j],"_io_r",r,".inp",sep="")
      ...
      if (file.exists(the.ud.out)==TRUE) {
        ...
        the.ud.text.bch.gender<-paste(
          ...
          "    BCHW1 BCHW2 BCHW3 BCHW4",
          "    CPROB1 CPROB2 CPROB3 CPROB4 N;",
          "    USEVARIABLES ARE GENDER BCHW1-BCHW4;",
          "    CLASSES = C(4);",
          #"    MISSING are all .;", #For some reason missing data is a problem in the new way of reading in BCH. We don't have any, so we're fine.
          "    IDVARIABLE = ID;",
          ...
          "   TECH3",
          "SAVEDATA:",
          "TECH3 = t3bchg_", the.datafile.ud.3step,
          sep="\n")  
        
        the.ud.name.bch.gender<-paste("M:/xstudy2/Simulation/aim02/July2017/sim/knownclass/rerun/",all.sets[[i]][j],"/",all.sets[[i]][j],"_ud_r",r,"_bch_gender.inp",sep="")
        the.ud.input.bch.gender<-file(the.ud.name.bch.gender)
        writeLines(the.ud.text.bch.gender, the.ud.input.bch.gender)
        close(the.ud.input.bch.gender)
        runModels(the.ud.name.bch.gender,replaceOutfile="never")
        ...
        the.ud.text.bch.frat<-paste(
          ...
          "    BCHW1 BCHW2 BCHW3 BCHW4",
          "    CPROB1 CPROB2 CPROB3 CPROB4 N;",
          "    USEVARIABLES ARE FRAT BCHW1-BCHW4;",
          "    CLASSES = C(4);",
          #"    MISSING are all .;", #For some reason missing data is a problem in the new way of reading in BCH. We don't have any, so we're fine.
          "    IDVARIABLE = ID;",
          "    TRAINING = BCHW1-BCHW4(BCH);",
          ...
          "   TECH3;",
          "SAVEDATA:",
          "TECH3 = t3bchf_", the.datafile.ud.3step,
          sep="\n")  
        
        the.ud.name.bch.frat<-paste("M:/xstudy2/Simulation/aim02/July2017/sim/knownclass/rerun/",all.sets[[i]][j],"/",all.sets[[i]][j],"_ud_r",r,"_bch_frat.inp",sep="")
        the.ud.input.bch.frat<-file(the.ud.name.bch.frat)
        writeLines(the.ud.text.bch.frat, the.ud.input.bch.frat)
        close(the.ud.input.bch.frat)
        runModels(the.ud.name.bch.frat,replaceOutfile="never")
        }
...
the.io.text.bch.gender<-paste(
  ...
  "   TECH3",
  "SAVEDATA:",
  "TECH3 = t3bchg_", the.datafile.io.3step,
  sep="\n")  

the.io.name.bch.gender<-paste("M:/xstudy2/Simulation/aim02/July2017/sim/knownclass/rerun/",all.sets[[i]][j],"/",all.sets[[i]][j],"_io_r",r,"_bch_gender.inp",sep="")
the.io.input.bch.gender<-file(the.io.name.bch.gender)
writeLines(the.io.text.bch.gender, the.io.input.bch.gender)
close(the.io.input.bch.gender)
runModels(the.io.name.bch.gender,replaceOutfile="never")
...
the.io.text.bch.frat<-paste(
  ...
  "   TECH3;",
  "SAVEDATA:",
  "TECH3 = t3bchf_", the.datafile.io.3step,
  sep="\n")  

the.io.name.bch.frat<-paste("M:/xstudy2/Simulation/aim02/July2017/sim/knownclass/rerun/",all.sets[[i]][j],"/",all.sets[[i]][j],"_io_r",r,"_bch_frat.inp",sep="")
the.io.input.bch.frat<-file(the.io.name.bch.frat)
writeLines(the.io.text.bch.frat, the.io.input.bch.frat)
close(the.io.input.bch.frat)
runModels(the.io.name.bch.frat,replaceOutfile="never")
}