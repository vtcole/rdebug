...
for (i in 1:4){
  for (j in 1:12) {
    for (r in 1:100) {
      the.output.v.io.frat<-readModels(paste0("C:/Users/vcole/Desktop/aim2/",all.sets[[i]][j],"/",all.sets[[i]][j],"_io_r",r,"_v_frat.out"))$parameters
      #the.output.bch.io.frat<-readModels(paste0("C:/Users/vcole/Desktop/aim2/",all.sets[[i]][j],"/",all.sets[[i]][j],"_io_r",r,"_bch_frat.out"))$parameters
      the.output.v.io.gender<-readModels(paste0("C:/Users/vcole/Desktop/aim2/",all.sets[[i]][j],"/",all.sets[[i]][j],"_io_r",r,"_v_gender.out"))$parameters
      #the.output.bch.io.gender<-readModels(paste0("C:/Users/vcole/Desktop/aim2/",all.sets[[i]][j],"/",all.sets[[i]][j],"_io_r",r,"_bch_gender.out"))$parameters
...
for (i in 1:4){
  for (j in 1:12) {
    for (r in 1:100) {
      the.output.v.ud.frat<-readModels(paste0("C:/Users/vcole/Desktop/aim2/",all.sets[[i]][j],"/",all.sets[[i]][j],"_ud_r",r,"_v_frat.out"))$parameters
      #the.output.bch.ud.frat<-readModels(paste0("C:/Users/vcole/Desktop/aim2/",all.sets[[i]][j],"/",all.sets[[i]][j],"_ud_r",r,"_bch_frat.out"))$parameters
      the.output.v.ud.gender<-readModels(paste0("C:/Users/vcole/Desktop/aim2/",all.sets[[i]][j],"/",all.sets[[i]][j],"_ud_r",r,"_v_gender.out"))$parameters
      #the.output.bch.ud.gender<-readModels(paste0("C:/Users/vcole/Desktop/aim2/",all.sets[[i]][j],"/",all.sets[[i]][j],"_ud_r",r,"_bch_gender.out"))$parameters
